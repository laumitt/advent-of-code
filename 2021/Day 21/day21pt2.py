...
# part 2 rules
# now the die only shows 1, 2, or 3
# every time you roll the universe splits for each die outcome
# game now ends at 21
# find player that wins in the most universes
# puzzle answer is number of winning universes
